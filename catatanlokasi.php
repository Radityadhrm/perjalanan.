					...
					<ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
						...
						<li class="nav-item">
							<a href="perjalanan.php" class="nav-link align-middle px-0 text-white">
								<i class="fs-4 bi bi-journal-text"></i> <span class="ms-1 d-none d-sm-inline">Isi Data Perjalanan</span>
							</a>
						</li>
						<li class="nav-item">
							<a href="catatan_lokasi" class="nav-link align-middle px-0 text-white">
								<i class="fs-4 bi bi-pencil-square"></i> <span class="ms-1 d-none d-sm-inline">catatan_lokasi</span>
							</a>
						</li>
						<li class="nav-item">
